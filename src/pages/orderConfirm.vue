    ...
    <modal
      ...
      <template v-slot:body>
        <div class="edit-wrap">
          ...
          <div class="item">
            <input type="text" v-model="checkedItem.receiverZip" class="input" placeholder="邮编">
          </div>
        </div>
      </template>
    </modal>
    <modal title="删除确认" btnType="1" :showModal="showDelModal" @cancel="showDelModal=false" @confirm="submitAddress">
      <template v-slot:body>
        <p>您确认要删除此地址吗？</p>
      </template>
    </modal>
